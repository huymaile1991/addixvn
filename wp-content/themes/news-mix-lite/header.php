                        ...
                        <div id="header-top" class="clearfix">
                            <div class="kp-headline-wrapper clearfix">
                                <?php if ('show' == get_theme_mod('news_mix_lite_options_display_headline_status', 'show')) { ?>
                                    <h6 class="kp-headline-title"><?php echo wp_kses_post( get_theme_mod('news_mix_lite_options_headline_title', esc_html__('ADDIX VIET NAM NEWS', 'news-mix-lite')) ); ?><span></span></h6>
                                <?php } // endif ?>
